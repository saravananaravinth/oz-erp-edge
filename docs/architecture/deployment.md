...
5. Smoke-test the candidate at 0% through a Worker version override.
...
Deployment scripts live in `.github/scripts` so parsing and rollout logic can be reviewed, linted,
