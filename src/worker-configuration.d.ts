/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=/dev/null src/worker-configuration.d.ts` (hash: 033443992681a33420053a4731aa886b)
// Runtime types generated with workerd@1.20260714.1 2026-07-15 
interface __BaseEnv_Env {
	...
	BLOCKED_BACKEND_PREFIXES: "/tasks,/metrics,/readyz,/healthz,/livez,/version,/erp/metrics,/erp/readyz,/erp/healthz,/erp/livez,/erp/version";
	...
	EXPOSED_HEADERS: "x-request-id,x-correlation-id,retry-after,x-ratelimit-scope,x-ratelimit-limit,x-ratelimit-remaining";
...
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./apps/worker/worker.entrypoint");
	}
